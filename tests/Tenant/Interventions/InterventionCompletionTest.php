...
it('sets \'completed_at\' when intervention is updated with status completed', function () {
...
it('sets \'completed_at\' when intervention status changes to completed', function () {
    Carbon::setTestNow(Carbon::now());
    $intervention = Intervention::factory()->withAction()->forLocation($this->room)->create(['planned_at' => Carbon::yesterday(), 'status' => InterventionStatus::PLANNED->value]);
