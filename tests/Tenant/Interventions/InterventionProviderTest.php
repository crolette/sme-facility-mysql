...
it('can create a new intervention for a PROVIDER', function () {
    ...
    $formData = [
        ...
        'locationId' => $this->provider->id,
        'locationType' => 'providers'
    ];
    ...
    assertDatabaseHas('interventions', [
        ...
        'interventionable_type' => get_class($this->provider),
        'interventionable_id' => $this->provider->id
    ]);
});
