...
class UsersExportController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        ExportUsersExcelJob::dispatch(Auth::user(), $validated)->onQueue('default');

        return ApiResponse::success([], 'Contacts will be exported, you will receive an e-mail when it\'s done');
    }
}
