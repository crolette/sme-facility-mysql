...
<head>
    <meta charset="utf-8">
    <title>{{ 'New ticket: ' . $ticket->code . ' - ' . $model->name}}</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            <h1 class="title">{{ 'New ticket: ' . $ticket->code . ' - ' . $model->name}}</h1>
        </div>
        ...
        <div class="content">
            <div class="alert">
                    ...
                    <div class="details">
                        <strong>Emplacement :</strong> {{ $ticket->asset_code }}  {{ $model->name }}<br>
                        <strong>Problem :</strong> {{ $ticket->description }}<br>
                        <strong>Notifier :</strong> {{ $ticket->reporter_email }}<br>
                        <a href={{ route('tenant.tickets.show', $ticket->id) }} class="button">View problem</a>
                    </div>
