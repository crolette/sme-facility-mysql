...
export default function Welcome() {
    return (
        <WebsiteLayout>
                        ...
                        <div className="grid gap-6 md:grid-cols-2">
                            <div className="flex flex-col space-y-6 md:items-end">
                                <div className="card bg-website-secondary flex flex-col rounded-md p-6 shadow-xl md:w-72">
                                    ...
                                    <p>
                                        Gagnez du temps en gérant toutes les informations sur vos équipements dans une seule et même application et
                                        gardez une trace de tout pour avoir une vue d’ensemble.
                                    </p>
                                </div>
                            ...
                            <div className="relative space-y-6">
                                ...
                                <div className="relative w-full">
                                    ...
                                    <div className="bg-website-secondary text-website-font w-full space-y-4 rounded-md p-6 md:ml-20">
                                        ...
                                        <p>
                                            Planifiez une intervention et transmettez les informations au responsable de maintenance ou à un
                                            prestataire.
                                        </p>
                                    </div>
                                </div>
            ...
            <section className="flex min-h-screen items-center py-40">
                <div className="container mx-auto">
                    <div className="text-website-font mx-auto h-full space-y-10 px-4 py-10 md:max-w-11/12 md:p-10">
