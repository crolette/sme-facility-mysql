...
export default function FeaturesRoles() {
    ...
    return (
        <WebsiteLayout>
            <Head title={t('website_features.roles.meta-title')}>
                <meta name="robots" content="index, follow"></meta>
                <meta property="title" content={t('website_features.roles.meta_title') + ' | ' + import.meta.env.VITE_APP_NAME} />
                <meta name="description" itemProp="description" property="description" content={t('website_features.roles.meta-description')} />

                <meta property="og:title" content={t('website_features.roles.meta-title-og')} />
                <meta property="og:description" content={t('website_features.roles.meta-description-og')} />
            </Head>
