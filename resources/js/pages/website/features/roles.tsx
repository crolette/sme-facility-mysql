    ...
    return (
        <WebsiteLayout>
            <Head>
                ...
                <meta property="title" content="SME-Facility | Rôles et gestion des accès utilisateurs" />
                <meta
                    name="description"
            ...
            <section className="bg-website-primary -mt-20 flex min-h-screen w-full items-center justify-center py-20 md:-mt-40">
                <div className="container mx-auto grid h-full gap-10 px-4 py-20 md:max-w-10/12 md:grid-cols-2 md:p-10">
                    <div className="flex flex-col justify-center gap-10 md:max-w-lg">
                        ...
                        <p className="">
                            Les QR codes SME-Facility permettent à n’importe quel utilisateur — collaborateur, occupant ou visiteur — de signaler un
                            incident instantanément. Un simple scan ouvre un formulaire de ticketing : description, photo, validation. Le responsable
                            de maintenance reçoit aussitôt la notification et peut planifier l’intervention.
                        </p>
            ...
            <section className="text-website-font flex min-h-screen w-full flex-col items-center justify-center py-40">
                <div className="container mx-auto flex h-full flex-col gap-10 px-4 md:max-w-10/12 md:gap-30">
                    <div className="grid gap-6 md:grid-cols-3">
                        ...
                        <div className="from-website-border rounded-md bg-linear-to-t to-transparent p-0.5">
                            <div className="grid h-full grid-rows-2 rounded-md bg-white p-6">
                                ...
                                <p>
                                    Tous les tickets sont liés à l’actif concerné, garantissant une vision claire de l’historique des problèmes et des
                                    actions menées.
                                </p>
                            </div>
                        </div>
