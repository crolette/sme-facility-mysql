...
export default function FeaturesMaintenance() {
    ...
    return (
        <WebsiteLayout>
            <Head title={t('website_features.maintenance.meta-title')}>
                <meta name="robots" content="index, follow"></meta>
                <meta property="title" content={t('website_features.maintenance.meta_title') + ' | ' + import.meta.env.VITE_APP_NAME} />
                <meta name="description" itemProp="description" property="description" content={t('website_features.maintenance.meta-description')} />

                <meta property="og:title" content={t('website_features.maintenance.meta-title-og')} />
                <meta property="og:description" content={t('website_features.maintenance.meta-description-og')} />
            </Head>
