            ...
            items.push(
                <details className="" open={i == 0 ? true : false} key={i}>
                    <summary className="cursor-pointer text-2xl font-bold">
                        <h3>{t(`website_features.statistics.faq.${i + 1}.question`)}</h3>
                        <hr className="mt-3" />
                    </summary>
                    <p className="mt-6 text-lg">{t(`website_features.statistics.faq.${i + 1}.answer`)}</p>
                </details>,
            );
        }
        return <>{items}</>;
                        ...
                        <div className="grid gap-6 md:grid-cols-3">
                            <div className="from-website-border rounded-md bg-linear-to-t to-transparent p-0.5">
                                <div className="grid h-full grid-rows-[1fr_2fr] gap-4 rounded-md bg-white p-6">
                                    <h6 className="font-semibold">{t('website_features.statistics.card-1.title')}</h6>
                                    <p>{t('website_features.statistics.card-1.description')}</p>
                                </div>
                            </div>
                            <div className="from-website-border rounded-md bg-linear-to-t to-transparent p-0.5">
                                <div className="grid h-full grid-rows-[1fr_2fr] gap-4 rounded-md bg-white p-6">
                                    <h6 className="font-semibold">{t('website_features.statistics.card-2.title')}</h6>
                                    <p>{t('website_features.statistics.card-2.description')}</p>
                                </div>
                            </div>
                            <div className="from-website-border rounded-md bg-linear-to-t to-transparent p-0.5">
                                <div className="grid h-full grid-rows-[1fr_2fr] gap-4 rounded-md bg-white p-6">
                                    <h6 className="font-semibold">{t('website_features.statistics.card-3.title')}</h6>
                                    <p>{t('website_features.statistics.card-3.description')}</p>
                                </div>
                            </div>
                        </div>
