                ...
                <div className="container">
                    <div className="mx-auto grid h-full gap-10 px-4 py-32 md:grid-cols-[2fr_1fr] md:gap-10 md:px-10 lg:max-w-11/12">
                        ...
                        <div className="mx-auto my-auto">
                            <img src="/images/website/features/hero_documents.jpg" alt="" className="blob h-auto max-w-72 shadow-2xl md:w-full" />
                        </div>
                    </div>
                </div>
            </section>
            <section className="text-website-font min-h-screen w-full py-40">
                <div className="container mx-auto">
                    <div className="mx-auto flex h-full flex-col gap-10 px-4 md:max-w-11/12 md:gap-30">
                        ...
                        <img src="/images/website/features/documents.png" alt="" className="mx-auto w-3/4" />
