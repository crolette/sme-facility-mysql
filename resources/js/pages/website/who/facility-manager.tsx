...
export default function WhoFacilityManager() {
    ...
    return (
        <WebsiteLayout>
            <Head title={t('website_who.facility_manager.meta-title')}>
                <meta name="robots" content="index, follow"></meta>
                <meta property="title" content={t('website_who.facility_manager.meta_title') + ' | ' + import.meta.env.VITE_APP_NAME} />
                <meta name="description" itemProp="description" property="description" content={t('website_who.facility_manager.meta-description')} />

                <meta property="og:title" content={t('website_who.facility_manager.meta-title-og')} />
                <meta property="og:description" content={t('website_who.facility_manager.meta-description-og')} />
            </Head>
