...
export default function WhoFacilityManager() {
    ...
    return (
        <WebsiteLayout>
            <Head title={t('website_who.facility_manager.meta_title')}>
                <meta name="robots" content="index, follow"></meta>
                <meta property="title" content={t('website_who.facility_manager.meta_title') + ' | ' + import.meta.env.VITE_APP_NAME} />
                <meta name="description" itemProp="description" property="description" content={t('website_who.facility_manager.meta_description')} />

                <meta property="og:title" content={t('website_who.facility_manager.meta_title_og')} />
                <meta property="og:description" content={t('website_who.facility_manager.meta_description_og')} />
            </Head>
                ...
                <div className="container mx-auto">
                    <div className="mx-auto grid h-full gap-10 px-4 py-32 md:grid-cols-[2fr_1fr] md:gap-10 md:px-10 lg:max-w-11/12">
                        <div className="flex flex-col justify-center gap-10">
                            ...
                            <h2 className="!text-xl">{t('website_who.facility_manager.subtitle')}</h2>
                            <p className="">{t('website_who.facility_manager.description')}</p>
